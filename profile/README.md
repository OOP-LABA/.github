...
1. Цели и проблемы Создать сайт-платформу для фриланс-заданий, ориентированную на студентов вузов, позволяющую размещать и выполнять учебные задания с оплатой ниже репетиторских услуг. Это решение необходимо для уменьшения стоимости образовательных услуг и создания удобного и эффективного канала взаимодействия студентов-заказчиков и студентов-исполнителей. Бизнес получает источник дохода в виде комиссии, пользователи — доступный рынок услуг и безопасные сделки.

2. Контекст Система / подсистема: Онлайн-платформа фриланса для студентов (веб-приложение)

Связанные документы:
Источник постановки: сбор требований на основе обсуждений и анализа рынка образовательных фриланс платформ

3. Трассировка требований (ID Тип Описание)
...
FR_006 Функциональное Система откликов (офферов) исполнителей на задания

NFR_001 Нефункциональное Безопасность данных и сделок

NFR_002 Нефункциональное Высокая доступность и производительность (при нагрузке 100 rps в пике)

3.1 Диаграмма прецендентов

<img width="551" height="1227" alt="image" src="https://github.com/user-attachments/assets/1fb3ec8e-e6df-4ee6-807f-e1143f5ab289" />
...
10. Возможность отклика исполнителей на задания в виде офферов (комментариев) 
с указанием предложения по выполнению задания (описание, цена, условия).

11. Отображение списка офферов в карточке задания с возможностью выбора 
исполнителя заказчиком.

12. Реализация топа исполнителей по рейтингу и отзывам
    
13. Поддержка ролевой модели пользователей системы на базе 2 основных ролей

Зарегистрированный пользователь (с базовыми правами доступа, включающими регистрацию и вход в систему, управление собственными заданиями, просмотр и отклик на задания других пользователей, выбор исполнителя и участие в выполнении заданий, редактирование собственного профиля, просмотр профилей других пользователей, рейтингов и отзывов, а также подачу жалоб.)

Администратор (пользователь с расширенными правами управления системой, включающими просмотр всех пользователей и заданий, модерацию и удаление заданий, блокировку и разблокировку пользователей, 
рассмотрение жалоб и принятие решений по ним, а также контроль соблюдения правил платформы)

14. Система должна поддерживать статусы заказов: OPEN (доступно для откликов), IN_PROGRESS (в работе), DONE (выполнено), CANCELLED (отменено).

4.2 Нефункциональные

1. Интуитивно понятный UI/UX для целевой аудитории

2. Надежность и отказоустойчивость платформы, восстановление в течение суток в случае непредвиденных происшествий

3. Система должна обеспечивать безопасное хранение и передачу персональных данных пользователей. Аутентификация пользователей должна осуществляться с использованием токенов доступа (JWT).

Диаграмма последовательностей для сценария авторизации
...
<img width="571" height="1526" alt="image" src="https://github.com/user-attachments/assets/20d2349c-ec30-428c-9b82-79b2dbe6b770" />
